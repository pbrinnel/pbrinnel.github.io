...
- Navigate by section, not by reading the file. `grep -n "// ---- " brandon.html` lists all 43 in order. Line numbers shift under edits from other sessions; section names don't.
